...
4. [Calling C++ Code From Kotlin with JNI (this one)]({% post_url synthesis/android-wavetable-synthesizer/2022-10-09-jni %})
...
In the [second part of this tutorial]({% post_url synthesis/android-wavetable-synthesizer/2022-08-10-ui %}), we discussed how to create its user interface (UI) using Jetpack Compose.

In the [third part of this tutorial]({% post_url synthesis/android-wavetable-synthesizer/2022-09-11-view-model %}), we implemented the bridge between the UI and the core logic of our app using the ViewModel.
...
The changes since [the last part]({% post_url synthesis/android-wavetable-synthesizer/2022-09-11-view-model %}) are:
